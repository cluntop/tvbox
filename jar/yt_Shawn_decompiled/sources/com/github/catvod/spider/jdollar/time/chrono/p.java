...
public final class p extends a implements Serializable {
    ...
    public final b C(TemporalAccessor temporalAccessor) {
        return temporalAccessor instanceof r ? (r) temporalAccessor : new r(this, temporalAccessor.E(com.github.catvod.spider.jdollar.time.temporal.a.EPOCH_DAY));
    }
    ...
    public final void S() {
        ...
        try {
            ...
            int[][] iArrX = X();
            int iF = (int) LocalDate.of(1882, 11, 12).F();
            for (int i = 1300; i <= 1600; i++) {
                int[] iArr = iArrX[i - 1300];
                if (iArr.length != 12) {
            ...
            for (int i2 = 1300; i2 < 1600; i2++) {
                int iY = Y(i2, 12);
                this.j = Math.min(this.j, iY);
                this.k = Math.max(this.k, iY);
            }
            this.c = true;
        } catch (Exception e) {
    ...
    public final int[] T(int i, Map map) {
        ...
        this.h = ManifestCreatorCache.DEFAULT_MAXIMUM_SIZE;
        ...
        for (int i3 = 1300; i3 <= 1600; i3++) {
            ...
            while (i4 < 12) {
                ...
                iArr[i2] = i;
                if (i5 < 29 || i5 > 32) {
                    com.github.catvod.spider.jdollar.nio.file.b.c("Invalid month length in year: 1300");
                    return null;
                }
                i += i5;
    ...
    public final long V(int i, int i2, int i3) {
        S();
        if (i2 < 1 || i2 > 12) {
            com.github.catvod.spider.jdollar.nio.file.b.d("Invalid Hijrah month: ", i2);
            return 0L;
        }
        ...
        if (i3 < 1 || i3 > W(i, i2)) {
            com.github.catvod.spider.jdollar.nio.file.b.d("Invalid Hijrah day of month: ", i3);
            return 0L;
        }
    ...
    public final b i() {
        return new r(this, LocalDate.b0(com.github.catvod.spider.jdollar.com.android.tools.r8.a.T()).E(com.github.catvod.spider.jdollar.time.temporal.a.EPOCH_DAY));
    }
    ...
    public final b m(int i, int i2) {
        ...
        com.github.catvod.spider.jdollar.nio.file.b.d("Invalid dayOfYear: ", i2);
        return null;
    }
    ...
    public final com.github.catvod.spider.jdollar.time.temporal.s s(com.github.catvod.spider.jdollar.time.temporal.a aVar) {
        ...
        switch (o.a[aVar.ordinal()]) {
            case 1:
                return com.github.catvod.spider.jdollar.time.temporal.s.g(1L, this.h, this.i);
            case 2:
                return com.github.catvod.spider.jdollar.time.temporal.s.f(1L, this.k);
            case 3:
                return com.github.catvod.spider.jdollar.time.temporal.s.f(1L, 5L);
            case 4:
            case 5:
                return com.github.catvod.spider.jdollar.time.temporal.s.f(U(0), U(this.d.length - 1) - 1);
            case 6:
                return com.github.catvod.spider.jdollar.time.temporal.s.f(1L, 1L);
            default:
                return aVar.b;
        }
    }
    ...
    @Override // com.github.catvod.spider.jdollar.time.chrono.l
    public final List u() {
        return com.github.catvod.spider.jdollar.com.android.tools.r8.a.B(s.values());
    }
    ...
    public final n v(int i) {
        ...
        com.github.catvod.spider.jdollar.nio.file.b.k("invalid Hijrah era");
        return null;
    }
