...
public final class f6 extends y implements y8 {
    ...
    public final g2 K(a aVar, Spliterator spliterator, IntFunction intFunction) {
        switch (this.m) {
            case StreamExtractor.NO_AGE_LIMIT /* 0 */:
                ...
                double[] dArr = (double[]) ((a2) aVar.p(spliterator, true, intFunction)).b();
                Arrays.sort(dArr);
                return new s2(dArr);
            case 1:
    ...
    public Spliterator L(a aVar, Spliterator spliterator) {
        switch (this.m) {
            case 1:
                return b7.ORDERED.o(aVar.f) ? K(aVar, spliterator, new t5(7)).spliterator() : new c9((com.github.catvod.spider.jdollar.util.r0) aVar.T(spliterator), 1);
            case 2:
                return b7.ORDERED.o(aVar.f) ? K(aVar, spliterator, new t5(8)).spliterator() : new c9((com.github.catvod.spider.jdollar.util.r0) aVar.T(spliterator), 0);
            default:
    ...
    public final m5 N(int i, m5 m5Var) {
        switch (this.m) {
            case StreamExtractor.NO_AGE_LIMIT /* 0 */:
                ...
                return b7.SIZED.o(i) ? new k6(m5Var) : new c6(m5Var);
            case 1:
                return new w8(this, m5Var);
            default:
                return new x8(this, m5Var, false);
        }
    }

    @Override // com.github.catvod.spider.jdollar.util.stream.y8
    public z8 g(y1 y1Var, boolean z) {
        return new x8(this, y1Var, z);
    }
}
