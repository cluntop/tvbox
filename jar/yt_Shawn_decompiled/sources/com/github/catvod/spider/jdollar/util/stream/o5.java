...
public final class o5 extends c5 {
    ...
    public final g2 K(a aVar, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (jF > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            return v3.B(aVar, v3.y(aVar2.H(), spliterator, this.m, this.n), true, intFunction);
        }
        ...
        return v3.B(this, new g8(spliteratorT, j, jMin), true, intFunction);
    }
    ...
    public final Spliterator L(a aVar, Spliterator spliterator) {
        ...
        if (jF > 0 && spliterator.hasCharacteristics(16384)) {
            Spliterator spliteratorT = aVar.T(spliterator);
            long j = this.m;
            return new a8(spliteratorT, j, v3.A(j, this.n));
        }
        if (b7.ORDERED.o(aVar.f)) {
            return ((g2) new x5(this, aVar, spliterator, new u0(19), this.m, this.n).invoke()).spliterator();
        }
        ...
        return new g8(spliteratorT2, j2, j3);
    }
