...
public final class b implements com.github.catvod.spider.merge.a1.a {
    ...
    public static final int[] n = {268439616, 4096, 262144, 268701760, 268435456, 268439616, 64, 268435456, 262208, 268697600, 268701760, 266240, 268701696, 266304, 4096, 64, 268697600, 268435520, 268439552, 4160, 266240, 262208, 268697664, 268701696, 4160, 0, 0, 268697664, 268435520, 268439552, 266304, 262144, 266304, 262144, 268701696, 4096, 64, 268697664, 4096, 266304, 268439552, 64, 268435520, 268697600, 268697664, 268435456, 262144, 268439616, 0, 268701760, 262208, 268435520, 268697600, 268439552, 268439616, 0, 268701760, 266240, 266240, 4160, 4160, 262208, 268435456, 268701696};
    public int[] a;
    ...
    public final void a(boolean z, com.github.catvod.spider.merge.a1.c cVar) {
        ...
        if (!(cVar instanceof g)) {
            com.github.catvod.spider.merge.s0.a.r("invalid parameter passed to DES init - ".concat(cVar.getClass().getName()));
            return;
        }
        byte[] bArr2 = ((g) cVar).a;
        if (bArr2.length > 8) {
            com.github.catvod.spider.merge.s0.a.r("DES key too long - should be 8 bytes");
            return;
        }
        int[] iArr = new int[32];
    ...
    @Override // com.github.catvod.spider.merge.a1.a
    public final int b(int i2, int i3, byte[] bArr, byte[] bArr2) throws androidx.startup.b {
        int[] iArr = this.a;
        if (iArr == null) {
            com.github.catvod.spider.merge.s0.a.h("DES engine not initialised");
            return 0;
        }
        if (i2 + 8 > bArr.length) {
        ...
        int iB = c2.b(bArr, i2);
        int iB2 = c2.b(bArr, i2 + 4);
        int i4 = ((iB >>> 4) ^ iB2) & 252645135;
        int i5 = iB2 ^ i4;
        int i6 = (i4 << 4) ^ iB;
        ...
        for (int i21 = 0; i21 < 8; i21++) {
            ...
            int i33 = iArr5[(i32 >>> 24) & 63] | iArr2[i32 & 63] | iArr3[(i32 >>> 8) & 63] | iArr4[(i32 >>> 16) & 63];
            int i34 = iArr[i22 + 3] ^ i20;
            i19 ^= (((i33 | iArr6[i34 & 63]) | iArr7[(i34 >>> 8) & 63]) | iArr8[(i34 >>> 16) & 63]) | iArr9[(i34 >>> 24) & 63];
        }
        ...
        c2.E(bArr2, i48 ^ (i49 << 4), i3);
        c2.E(bArr2, i47 ^ i49, i3 + 4);
        return 8;
    }
